...
/**
 * Interface for college location data
 */
...
/**
 * Interface for college data returned from API
 */
interface College {
    _id: string;
    name: string;
...
/**
 * Admin Colleges Management component.
 * Displays paginated list of colleges with search and CRUD operations.
 */
