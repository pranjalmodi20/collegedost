    ...
    <section className="mb-20 relative">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          ...
          <a href="#" className="flex items-center gap-2 text-sm font-bold text-brand-indigo bg-indigo-50 px-5 py-2.5 rounded-full hover:bg-brand-indigo hover:text-white transition-all duration-300 shadow-sm hover:shadow-md group">
