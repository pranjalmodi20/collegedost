...
import { FaClock, FaCheckCircle, FaMoneyBillWave, FaBuilding, FaMapMarkerAlt, FaBriefcase } from 'react-icons/fa';
                                                ...
                                                <tbody className="divide-y divide-gray-200">
                                                    {Object.entries(course.highlights).map(([key, val]) => (
                                                        <tr key={key} className="bg-white hover:bg-gray-50">
                                                            ...
                                                            <td className="px-4 py-3 text-gray-600">{val as React.ReactNode}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
                            ...
                            <div className="space-y-8 animate-fade-in">
                                ...
                                {course.syllabus && course.syllabus.length > 0 ? (
                                    <div className="grid gap-4">
                                        {course.syllabus.map((sem: any, idx: number) => (
                            ...
                            <div className="space-y-8 animate-fade-in">
                                    ...
                                    {course.jobRoles && course.jobRoles.length > 0 ? (
                                        <div className="overflow-hidden border border-gray-200 rounded-lg mb-6">
                                            <table className="w-full text-sm text-left">
                                                ...
                                                <tbody className="divide-y divide-gray-200">
                                                    {course.jobRoles.map((role: any, idx: number) => (
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        {course.topRecruiters && course.topRecruiters.map((rec: string, i: number) => (
                                            ...
                                            <div key={college._id} className="border border-gray-100 rounded-xl p-4 flex flex-col md:flex-row gap-4 hover:shadow-md transition">
                                                ...
                                                <div className="flex-1">
                                                    <h3 className="font-bold text-lg text-gray-900">
                                                        <Link href={`/colleges/${college.slug}`} className="hover:text-brand-indigo transition">
                                                            {college.name}
                                                        </Link>
                                                    </h3>
                                                ...
                                                <div className="flex items-center">
                                                    <Link href={`/colleges/${college.slug}`} className="px-4 py-2 bg-brand-indigo text-white text-sm font-bold rounded-lg hover:bg-indigo-700 transition">
                                                        View Details
                                                    </Link>
                                                </div>
                                            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={i}>
                                    <Link href={c.link} className="flex items-center justify-between text-gray-600 hover:text-brand-indigo transition group">
