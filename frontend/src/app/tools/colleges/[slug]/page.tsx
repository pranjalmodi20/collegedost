...
const CollegeDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white border-b border-gray-200">
                ...
                <div className="h-64 md:h-80 w-full relative bg-gray-200 overflow-hidden">
                    {college.bannerImage ? (
                        ...
                        <div className="w-full h-full bg-linear-to-r from-blue-900 to-brand-blue flex items-center justify-center">
                ...
                <div className="container mx-auto px-4 relative pb-6">
                    <div className="flex flex-col md:flex-row items-end gap-6">
                        ...
                        <div className="-mt-16 md:-mt-20 w-32 h-32 md:w-40 md:h-40 bg-white rounded-2xl shadow-xl border-4 border-white flex items-center justify-center overflow-hidden shrink-0 z-10 relative">
                            {college.logo ? (
            ...
            {/* --- NAVIGATION TABS --- */}
            <div className="sticky top-18 z-40 bg-white shadow-sm border-b border-gray-200 overflow-x-auto hide-scrollbar">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {college.highlights.map((point, idx) => (
                                            <div key={idx} className="flex items-start gap-3 bg-blue-50/50 p-3 rounded-lg border border-blue-100/50">
                                                <FaCheckCircle className="text-brand-blue mt-1 shrink-0" />
                        ...
                        <div className="space-y-6 animate-fade-in">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                    <div className="bg-linear-to-br from-blue-50 to-white p-6 rounded-2xl border border-blue-100 text-center">
                                    ...
                                    <div className="bg-linear-to-br from-orange-50 to-white p-6 rounded-2xl border border-orange-100 text-center">
                                    ...
                                    <div className="bg-linear-to-br from-purple-50 to-white p-6 rounded-2xl border border-purple-100 text-center">
                                ...
                                {college.infrastructure?.facilities?.map((fac: any, idx: number) => {
                                    ...
                                    return (
                                        <div key={idx} className="flex gap-4 p-4 rounded-xl border border-gray-100 hover:shadow-md transition bg-gray-50/50">
                                            <div className="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center text-brand-blue text-xl border border-gray-100 shrink-0">
                                                <IconComponent />
                                            </div>
                                            <div>
