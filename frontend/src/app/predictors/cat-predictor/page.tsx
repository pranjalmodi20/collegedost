...
export const metadata = {
    title: 'CAT College Predictor 2026 | CollegeDost',
    description: 'Predict your admission chances in IIMs and other top B-schools based on CAT percentile.',
};

export default function CATPredictorPage() {
    return (
