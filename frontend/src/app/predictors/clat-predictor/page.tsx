...
export const metadata = {
    title: 'CLAT College Predictor 2026 | CollegeDost',
    description: 'Predict your admission chances in NLUs based on CLAT rank or score.',
};

export default function CLATPredictorPage() {
    return (
