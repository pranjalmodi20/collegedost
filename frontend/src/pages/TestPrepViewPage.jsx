...
const TestPrepViewPage = () => {
    ...
    if (error || !data) return (
        <div className="min-h-screen pt-24 flex flex-col items-center justify-center bg-gray-50">
            ...
            <Link to="/" className="px-6 py-2 bg-brand-blue text-white rounded-lg hover:bg-blue-700 transition">
                Go Home
            </Link>
        </div>
    );
                        ...
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <Link to="/test-prep/engineering/jee-main/preparation" className="block text-gray-600 hover:text-brand-blue hover:translate-x-1 transition text-sm">
                                            JEE Main Preparation
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/test-prep/engineering/jee-advanced/preparation" className="block text-gray-600 hover:text-brand-blue hover:translate-x-1 transition text-sm">
                                            JEE Advanced Strategy
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/test-prep/engineering/bitsat/preparation" className="block text-gray-600 hover:text-brand-blue hover:translate-x-1 transition text-sm">
                                            BITSAT Crash Course
                                        </Link>
                                    </li>
                                </ul>
