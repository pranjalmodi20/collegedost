...
const MedicinePage = ({ onOpenAskModal }) => {
  return (
    <>
      <SEO 
        title="Medicine & Allied Sciences" 
        description="Find top medical colleges, NEET exams, ranking info, and medical career guidance in India."
        keywords="NEET, MBBS, Medical Colleges, AIIMS, BDS, Doctor, Health Science"
      />
      <Hero 
        title={
          <>
      ...
      <div className="container mx-auto px-4 py-12 flex-grow flex flex-col gap-16">
        ...
        <Counselling items={medicineCounsellingData} onOpenAskModal={onOpenAskModal} />
