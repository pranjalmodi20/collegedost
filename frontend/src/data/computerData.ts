...
export const featuredComputerColleges = [
    {
        ...
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8b/NIT_Tiruchirappalli_logo.svg/1200px-NIT_Tiruchirappalli_logo.svg.png",
        tags: ["NIT", "Premier"],
        fees: "₹ 3L Total Fees",
    ...
    },
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/8/80/Jawaharlal_Nehru_University_logo.svg/1200px-Jawaharlal_Nehru_University_logo.svg.png",
...
export const computerCounsellingData = [
    {
        title: "IT Career Guide",
        description: "Complete guide to MCA, BCA, and software development careers.",
    ...
    {
        title: "Ask IT Experts",
        description: "Get personalized guidance for MCA/BCA admissions and tech careers.",
...
export const computerCoursesData = [
    {
        title: "Popular Computer Courses",
        items: [
            { name: "BCA (Bachelor of Computer Applications)", link: "#" },
            { name: "MCA (Master of Computer Applications)", link: "#" },
            { name: "B.Sc Computer Science", link: "#" },
            { name: "B.Sc IT (Information Technology)", link: "#" },
            { name: "PGDCA", link: "#" }
        ]
    },
    {
        ...
        items: [
            ...
            { name: "Artificial Intelligence & ML", link: "#" },
