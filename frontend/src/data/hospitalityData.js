...
export const featuredHospitalityColleges = [
    {
        ...
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Institute_of_Hotel_Management_Mumbai_logo.svg/1200px-Institute_of_Hotel_Management_Mumbai_logo.svg.png",
    ...
    },
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/2/25/IHM_Pusa_logo.png",
    ...
    },
    {
        ...
        rating: "AAAA",
        logo: "https://images.collegedunia.com/public/college_data/images/logos/1568709095wgsha.png",
...
export const hospitalityCounsellingData = [
    {
        title: "Hotel Management Career Guide",
        description: "Complete guide to career opportunities in Hotel Management and Hospitality.",
    ...
    {
        title: "Ask Hospitality Experts",
        description: "Get personalized guidance for hotel management admissions and careers.",
...
export const hospitalityCoursesData = [
    {
        title: "Popular Hospitality Courses",
        items: [
            { name: "B.Sc Hotel Management", link: "#" },
            { name: "BHM (Bachelor of Hotel Management)", link: "#" },
            { name: "B.Sc Culinary Arts", link: "#" },
            { name: "B.Sc Travel & Tourism", link: "#" },
    ...
    },
    {
        ...
        items: [
            { name: "Food Production", link: "#" },
            { name: "Front Office Management", link: "#" },
            { name: "Housekeeping", link: "#" },
            { name: "Food & Beverage Service", link: "#" },
