...
export const featuredEducationColleges = [
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/d/d8/NCERT_logo.svg/1200px-NCERT_logo.svg.png",
    ...
    },
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/University_of_Delhi_logo.svg/1200px-University_of_Delhi_logo.svg.png",
        tags: ["DU", "Prestigious"],
        fees: "₹ 40K Total Fees",
    ...
    },
    {
        ...
        location: "New Delhi",
        rating: "AAAA",
        logo: "https://images.collegedunia.com/public/college_data/images/logos/1433142854logo.jpg",
...
export const educationCounsellingData = [
    {
        title: "Teaching Career Guide",
        description: "Complete guide to becoming a teacher - from B.Ed to CTET to Government Jobs.",
    ...
    {
        title: "Ask Education Experts",
        description: "Get personalized guidance for B.Ed admissions and teaching careers.",
...
export const educationCoursesData = [
    {
        title: "Popular Education Courses",
        items: [
            { name: "B.Ed (Bachelor of Education)", link: "#" },
            { name: "D.El.Ed (Diploma in Elementary Education)", link: "#" },
            { name: "B.El.Ed (Bachelor of Elementary Education)", link: "#" },
            { name: "M.Ed (Master of Education)", link: "#" },
            { name: "NTT (Nursery Teacher Training)", link: "#" }
        ]
    },
    {
        ...
        items: [
            ...
            { name: "Physical Education (B.P.Ed)", link: "#" },
            { name: "Educational Psychology", link: "#" },
            { name: "Curriculum Development", link: "#" },
            { name: "Educational Technology", link: "#" }
        ]
    }
];
