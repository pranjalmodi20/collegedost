...
const engSpec = (label: string): MegaMenuLink => ({
  label,
  href: `/engineering/${label.toLowerCase().replace(/\s+&/g, '').replace(/[\s&]+/g, '-').replace(/-+/g, '-')}`,
  comingSoon: false,
});
  ...
  subcategories: [
    {
      ...
      columns: [
        {
          links: [
            cs('Top MBA Colleges in India'),
            cs('Top Private MBA Colleges in India'),
            cs('Top MBA Colleges in Bangalore'),
            cs('Top MBA Colleges in Mumbai'),
            cs('Top MBA Colleges in Pune'),
            cs('Top MBA Colleges in Hyderabad'),
            cs('Top MBA Colleges in Delhi'),
            cs('Top MBA Colleges in Chennai'),
            cs('Top MBA Colleges in Maharashtra'),
            cs('Top MBA Colleges in Kolkata'),
            cs('Top MBA Colleges in Kerala'),
          ],
        },
      ],
    },
  ...
  subcategories: [
    {
      ...
      columns: [
        {
          links: [
            cs('Top Engineering Colleges in India'),
            cs('Top Private Engineering Colleges in India'),
            cs('Top IITs in India'),
            cs('Top NITs in India'),
            cs('Top Engineering Colleges in Bangalore'),
            cs('Top Engineering Colleges in Karnataka'),
            cs('Top Engineering Colleges in Hyderabad'),
            cs('Top Engineering Colleges in Pune'),
            cs('Top Engineering Colleges in Mumbai'),
            cs('Top Engineering Colleges in Maharashtra'),
            cs('Top Engineering Colleges in Chennai'),
            cs('Top Engineering Colleges in Kerala'),
            cs('Top Engineering Colleges in Delhi'),
            cs('Top Engineering Colleges in Telangana'),
            cs('Top Engineering Colleges in Gujarat'),
            cs('Top Engineering Colleges in West Bengal'),
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      columns: [
        {
          links: [
            engSpec('Computer Science Engineering'),
            engSpec('Mechanical Engineering'),
            engSpec('Civil Engineering'),
            engSpec('Electronics & Communication Engineering'),
            engSpec('Aeronautical Engineering'),
            engSpec('Aerospace Engineering'),
            engSpec('Information Technology'),
            engSpec('Electrical Engineering'),
            engSpec('Electronics Engineering'),
            engSpec('Nanotechnology'),
            engSpec('Chemical Engineering'),
            engSpec('Automobile Engineering'),
            engSpec('Biomedical Engineering'),
            engSpec('Construction Engineering'),
            engSpec('Pulp & Paper Technology'),
          ],
        },
        {
          links: [
            engSpec('Marine Engineering'),
            engSpec('Genetic Engineering'),
            engSpec('Food Technology'),
            engSpec('Petroleum Engineering'),
            engSpec('Control Systems'),
            engSpec('Industrial Engineering'),
            engSpec('Production Engineering'),
            engSpec('Environmental Engineering'),
            engSpec('Robotics Engineering'),
            engSpec('Telecommunication Engineering'),
            engSpec('Materials Science'),
            engSpec('Structural Engineering'),
            engSpec('Aircraft Maintenance'),
            engSpec('RF & Microwave Engineering'),
          ],
        },
        {
          links: [
            engSpec('VLSI Design'),
            engSpec('Mechatronics Engineering'),
            engSpec('Mining Engineering'),
            engSpec('Biotechnology Engineering'),
            engSpec('Transportation Engineering'),
            engSpec('Metallurgical Engineering'),
            engSpec('Textile Engineering'),
            engSpec('Naval Architecture'),
            engSpec('Power Engineering'),
            engSpec('Dairy Technology'),
            engSpec('Microelectronics'),
            engSpec('Communications Engineering'),
            engSpec('Tool Engineering'),
            engSpec('Ceramic Engineering'),
            engSpec('Jute & Fiber Technology'),
          ],
        },
      ],
    },
  ...
  subcategories: [
    {
      ...
      columns: [
        {
          links: [
            cs('Top Medical Colleges in India'),
            cs('Top Medical Colleges in Karnataka'),
            cs('Top Pharmacy Colleges in India'),
            cs('Top Medical Colleges in Bangalore'),
            cs('Top Dental Colleges in India'),
            cs('Top Medical Colleges in Maharashtra'),
            cs('Top Medical Colleges in Mumbai'),
            cs('Top Medical Colleges in Delhi'),
            cs('Top Pharmacy Colleges in Maharashtra'),
          ],
        },
      ],
    },
  ...
  subcategories: [
    {
      ...
      columns: [
        {
          links: [
            cs('Top Fashion Designing Colleges in India'),
            cs('Top Fashion Designing Colleges in Bangalore'),
            cs('Top Fashion Designing Colleges in Delhi/NCR'),
          ],
        },
      ],
    },
