...
export const featuredMediaColleges = [
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/3/32/Indian_Institute_of_Mass_Communication_Logo.svg/1200px-Indian_Institute_of_Mass_Communication_Logo.svg.png",
    ...
    },
    {
        ...
        location: "New Delhi",
        rating: "AAAA+",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/c/ce/Jamia_Millia_Islamia_Logo.svg/1200px-Jamia_Millia_Islamia_Logo.svg.png",
    ...
    },
    {
        ...
        rating: "AAAA",
        logo: "https://images.collegedunia.com/public/college_data/images/logos/1432627553logo.jpg",
    ...
    },
    {
        ...
        rating: "AAAA",
        logo: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Symbiosis_International_University_logo.svg/1200px-Symbiosis_International_University_logo.svg.png",
        tags: ["Deemed", "SET"],
        fees: "₹ 10L Total Fees",
...
export const mediaCounsellingData = [
    {
        title: "Media Career Guide",
        description: "Comprehensive guide to careers in Journalism, PR, Advertising & Media.",
    ...
    {
        title: "Ask Media Experts",
        description: "Get personalized guidance for media and journalism career queries.",
        image: "https://images.unsplash.com/photo-1559523161-0fc0d8b38a7a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        cta: "Ask Now",
        link: "#",
        color: "bg-blue-50"
    }
...
export const mediaCoursesData = [
    {
        title: "Popular Media Courses",
        items: [
            { name: "BJMC (Bachelor of Journalism & Mass Communication)", link: "#" },
            { name: "B.A. Journalism", link: "#" },
            { name: "B.Sc Animation & Multimedia", link: "#" },
            { name: "MJMC (Master of Journalism)", link: "#" },
            { name: "PG Diploma in Journalism", link: "#" }
        ]
    },
    {
        title: "Specializations",
        items: [
            { name: "Print Journalism", link: "#" },
            { name: "Broadcast Journalism", link: "#" },
            { name: "Digital Media", link: "#" },
            { name: "Public Relations", link: "#" },
